...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { description: @comic.description, genre: @comic.genre, state: @comic.state, title: @comic.title }
    end
  ...
  test "should update comic" do
    patch :update, id: @comic, comic: { description: @comic.description, genre: @comic.genre, state: @comic.state, title: @comic.title }
    assert_redirected_to comic_path(assigns(:comic))
  end
